<template>
  <div class="grid grid-cols-3 gap-5 print:gap-3">
    <div class="border border-gray-300" v-for="i in 12" :key="i">
      <h4 class="bg-red-500 print:bg-white print:text-black p-1 text-center text-white text-sm py-0.5 font-bold">{{ $t(month_names[i - 1]) }}</h4>
